...
const perguntas = [
  ...
  {
    pergunta: "Qual a região original do Bulbasaur?",
    respostas: [
  ...
  {
    pergunta: "Qual o tipo do Charmander?",
    respostas: [
  ...
  {
    pergunta: "Qual a evolução final do Squirtle?",
    respostas: [
      { opcao: "Blastoise", correto: true },
      { opcao: "Wartortle", correto: false },
      { opcao: "Charizard", correto: false },
    ],
  },
  {
    pergunta: "Quem é o rival de Ash na primeira temporada?",
    respostas: [
  ...
  {
    pergunta:
      "Qual o nome da equipe de vilões que Ash enfrenta frequentemente?",
    respostas: [
